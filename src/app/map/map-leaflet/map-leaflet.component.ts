...
if (navigator.geolocation) {
  // If it is available, use getCurrentPosition() to get the user's location
  navigator.geolocation.getCurrentPosition(position => {
    // Set the center object based on the user's location
    this.center = {
  ...
  // Handle the case where the Geolocation API is not available
